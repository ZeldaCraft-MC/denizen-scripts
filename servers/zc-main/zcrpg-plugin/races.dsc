        ...
        - choose <yaml[<context.damager.uuid>].read[race]>:
          ...
          - case gerudo:
            - if <context.entity.health_percentage||100> <= 25:
              - define damage:*:1.5
          - case zora:
            - if <util.random_decimal> <= 0.10:
              - narrate "<&b>[Zora Perk] <&e>Health restored!" player:<context.damager>
              - heal 2 <context.damager>
          - case fairy:
            - if <context.entity.is_living> && <util.random_decimal> <= 0.04:
              - define effects <list[poison|slow|weakness].exclude[<context.entity.effects_data.parse[get[type]]>]||null>
